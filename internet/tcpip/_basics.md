...
| 階層               | プロトコル        | 送信データ                  | メモリ領域   | デバイス     |
| -                  | -                 | -                           | -            | -            |
| アプリケーション層 | HTTP, SMTP etc    | アプリケーションデータ      | ユーザー空間 | ゲートウェイ |
| トランスポート層   | TCP, UDP etc      | TCPセグメント, データグラム | カーネル空間 | ゲートウェイ |
| ネットワーク層     | IP, ICMP, ARP etc | IPデータグラム              | カーネル空間 | ルーター     |
| データリンク層     | Ethernet etc      | データフレーム              | ハードウェア | スイッチ     |
