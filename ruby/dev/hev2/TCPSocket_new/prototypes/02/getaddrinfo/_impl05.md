# 2024/1/9
- `do_rb_getaddrinfo2`に渡す引数を用意する`allocate_rb_getaddrinfo2_arg`を追加
...
#endif
    pthread_t th;
    do_pthread_create(&th, 0, do_rb_getaddrinfo2, arg);
    pthread_detach(th);
