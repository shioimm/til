...
rb_getaddrinfo_happy_main(int argc, VALUE *argv, VALUE self)
{
    ...
    rb_thread_call_without_gvl2(wait_happy_eyeballs_fds, &wait_arg, cancel_happy_eyeballs_fds, &arg);
...
void * wait_happy_eyeballs_fds(void *ptr);
void cancel_happy_eyeballs_fds(void *ptr);
// -------------------------
```
