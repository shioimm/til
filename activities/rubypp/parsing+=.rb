...
# Reducing stack by rule 781 (line 5914):                     -> ($default) none : / (none) -> State 577
...
# ----------------------------
#
# Entering state 35                                           user_variableへの還元を開始 (-> tOP_ASGNが必要)
...
# ----------------------------
#
# Entering state 122                                          var_lhsへの還元を開始 (-> tOP_ASGNが必要)
...
# Stack now 0 2 71 313 125                                    (-> tOP_ASGN lex_ctxt command_rhsが必要)
# Next token is token "operator-assignment" (2.2-2.4: +)      次のトークンはtOP_ASGN (+=)
# Shifting token "operator-assignment" (2.2-2.4: +)           -> (tOP_ASGN) トークンをシフト
#
# ----- semantic stack -------
...
# ----------------------------
#
# Entering state 658                                          simple_numericへの還元を開始 (-> tINTEGERが必要)
# Stack now 0 2 71 313 125 429 658
# Reading a token                                             トークンを読み込み
# lex_state: BEG -> END at line 8679                          parse_numeric()
# lex_state: END -> END at line 7973                          set_number_literal()
# Next token is token "integer literal" (2.5-2.6: 1)          次のトークンはtINTEGER (1)
# Shifting token "integer literal" (2.5-2.6: 1)               -> (tINTEGER) トークンをシフト / State 41
#
# ----- semantic stack -------
